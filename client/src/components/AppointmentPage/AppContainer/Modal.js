            ...
            <div className="relative  my-6 mx-5 max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col  bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-between p-5  rounded-t">
                  ...
                  <FontAwesomeIcon onClick={() => setShowModal(false)} icon={faCircleXmark} className='cursor-pointer text-gray-400'/>
                </div>
                {/*body*/}
                <div className="relative p-6 flex-auto">
                  <div className="w-full ">
                    ...
                    >
                      ...
                      <input className="bg-textDefault text-white py-3 rounded-md font-bold cursor-pointer my-3" type="submit" />
                    </form>
                  </div>
                </div>
              </div>
